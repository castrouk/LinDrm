...
/* Classes ********************************************************************/
class CDRMTransmitter : public QThread
{
	Q_OBJECT
...
public:
  ...
  void Start();
  void Stop();
  void setWFfile(QString fname){m_wfFile = fname;}
  void Open_WF_file(QString f);
  bool Read_WF_file(CVector<_SAMPLE>& psData, bool loop);
